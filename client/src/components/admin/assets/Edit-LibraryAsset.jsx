  ...
  useEffect(() => {
    if (currentAsset) {
      setFormData({
        ...
        callNumber: currentAsset.callNumber || '',
      ...
      if (currentAsset.coverImage) {
        setImagePreview(currentAsset.coverImage);
      }
    }
  }, [currentAsset]);
    ...
    <div className="dashboard-content">
      <div className="container-fluid">
        ...
        <div className="alert alert-info mb-4" role="alert">
          ...
          Fill in the required fields marked with <span className="text-danger">*</span> to update the library asset.
        </div>
